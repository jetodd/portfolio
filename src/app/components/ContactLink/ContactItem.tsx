    ...
    const renderIconSelection = () => {
        switch (icon) {
          ...
          case 'resume':
            return (
                <>
                    <path d="M416 221.25V416a48 48 0 01-48 48H144a48 48 0 01-48-48V96a48 48 0 0148-48h98.75a32 32 0 0122.62 9.37l141.26 141.26a32 32 0 019.37 22.62z" fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="32"/>
    ...
    return (
        <div className="parent w-[60px] h-[60px] mb-4 md:w-[120px] md:h-[120px] md:mb-2 relative">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                width="438.821px" height="438.82px" viewBox="0 0 438.821 438.82" className={`${styles.spiky} w-[70px] h-[70px] md:w-[120px] md:h-[120px] block`} fill="white">
                    <g>
