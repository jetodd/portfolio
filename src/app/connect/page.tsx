export default function Page() {
    return <main 
      ...
      <section className="-my-32 md:my-0">
        <div className="grid grid-cols-1 md:grid-cols-4 mx-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white py-1 text-black content-center">
            <a href="mailto:jessstodd@gmail.com">
              <span className="grid place-content-center">
                <svg className="w-[80px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><rect x="48" y="96" width="416" height="320" rx="40" ry="40" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32"/><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M112 160l144 112 144-112"/></svg>
              </span>
              Email
            </a>
          </div>
